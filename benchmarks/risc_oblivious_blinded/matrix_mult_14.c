...
static int A_nrow = (1<<7);
static int A_ncol = (1<<7);
static int B_nrow = (1<<7);
static int B_ncol = (1<<7);
...
int main(){
    ...
    int* A = (int*) blinded_malloc(sizeof(int) * A_nrow * A_ncol);
    InitMatrix(A, A_nrow, A_ncol);

    int* B = (int*) blinded_malloc(sizeof(int) * B_nrow * B_ncol);
    InitMatrix(B, B_nrow, B_ncol);

    int* C = (int*) blinded_malloc(sizeof(int) * C_nrow * C_ncol);
